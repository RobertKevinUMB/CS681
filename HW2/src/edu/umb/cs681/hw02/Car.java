...
public class Car {
    ...
    public static void main(String[] args) {
        ...
        car_List.add(new Car("Ford", "Mustang", 2021,30000,20));
        car_List.add(new Car("Srt", "Dodge", 2019,40000,18));
        car_List.add(new Car("BMW", "320d",2019, 45000, 22));
        car_List.add(new Car("Audi", "A4", 2022,46000,22));



        Int min_Price = car_List.stream().mapToInt((Car car) -> car.getPrice()).min();
        System.out.println("Cheap priced car: "+min_Price.getAsInt());

        Int max_Price = car_List.stream().mapToInt((Car car) -> car.getPrice()).max();
        System.out.println("Highest priced car: "+max_Price.getAsInt());
